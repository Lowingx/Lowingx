...
Construo pipelines de detecção, telemetria de segurança e ferramentas focadas em Blue Team. Apaixonada por Linux, automação e análise de ameaças. Meu objetivo é me mudar para a Europa (Portugal ou Finlândia preferencialmente) em 2026 para atuar como Analista SOC ou Detection Engineer.
...
- Wazuh • ELK Stack • MITRE ATT&CK • OWASP Top 10

**Recon & Automation**  
- Reconnaissance pipelines • Subdomain enumeration • Nuclei • FFUF  
- Python • Bash • Wireshark • Burp Suite
...
- Detecção de probing em endpoints sensíveis (wp-admin, .env, phpmyadmin)  
...
**Vamos conversar?**  
- LinkedIn: [Aqui!](www.linkedin.com/in/gustavo-almeida-ti/)  🏳️‍⚧️
- Email: 
